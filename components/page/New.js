...
var New = function (_React$Component) {
  ...
  _createClass(New, [{
    ...
    value: function handleSubmit(e) {
      ...
      _axios2.default.post('/api/books/' + this.props.match.params.id, this.state).then(function () {
        return _this2.props.history.push('/api/books/' + _this2.props.match.params.id);
      });
    }
  }, {
    key: 'render',
